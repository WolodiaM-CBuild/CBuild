...
namespace CBuild
{
  namespace fs
  {
    ...
    typedef enum
    {
      ...
      DIR,
      /**
       * @brief Standard symlink (can be unsupported or supported partially) (thought std::filesystem::create_symlink)
       */
      SYMLINK_FILE,
      /**
       * @brief Standard symlink (can be unsupported or supported partially) (std::filesystem::create_directory_symlink)
       */
      SYMLINK_DIRECTORY,
      /**
      ...
      SYMLINK_DIR,
      /**
       * @brief Standard hardlink (can be unsupported or supported partially) (though std::filesystem::create_hard_link)
       */
      HARDLINK
    } type;
    /**
     ...
     * @param paths => std::vector<std::string> -> Path to new element, ans some other arguments (for symlinks)
