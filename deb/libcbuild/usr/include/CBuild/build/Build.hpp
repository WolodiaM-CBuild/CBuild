...
namespace CBuild
{
    ...
    protected:
         ...
         * 
         * @return lib::map<std::string, std::string> -> list of files, key - code, value - object
         */
    ...
    public:
         ...
         * 
         * @param args => std::vector<std::string>* -> argument for call, pointer, nonull
        ...
        /**
         * @brief Add system library include, library include folder need to be in PATH
         * 
         * @param library => std:string -> library name, will be used as -l<library>
         */
        virtual void add_library_include(std::string library);
        /**
         * @brief Add library include directory (with *.h files) and directory with library *.a and *.so/*.dll files
         * 
         * @param include => std:string -> include dir, will be used as -I<include>
         * @param lib => std:string -> library dir, will be used as -L<lib>
         */
        virtual void add_library_dir(std::string include, std::string lib);
        /**
         * @brief Add required task, that task will be executed before toolchain, it can have dependecies, but toolchain can depend on multiple tasks also
         * 
